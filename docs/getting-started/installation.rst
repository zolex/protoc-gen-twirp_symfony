...
.. code-block:: bash
    ...
    $ protoc --plugin=protoc-gen-twirp_symfony=path/to/protoc-gen-twirp_symfony ...
...
.. code-block:: bash
    ...
    $ go get github.com/twirphp/twirp/protoc-gen-twirp_symfony
    $ cd $GOROOT/src/github.com/twirphp/twirp/protoc-gen-twirp_symfony
    $ dep ensure
    $ go install
